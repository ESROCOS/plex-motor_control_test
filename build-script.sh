...
INTERFACEVIEW=plex-motor_control_test_iv.aadl
grep "version => \"2" plex-motor_control_test_iv.aadl >/dev/null && {
    echo -e "${INFO} Converting interface view from V2 to V1.3"
    TASTE --load-interface-view plex-motor_control_test_iv.aadl --export-interface-view-to-1_3 __iv_1_3.aadl
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subCPP controldevice:/home/taste/esrocos_workspace/install/drivers/taste/controldev/controldevice.zip \
	--subCPP joystick_2_joint_commands:/home/taste/esrocos_workspace/install/drivers/taste/controldev/joystick_2_joint_commands.zip \
	--subC gr740_candriver:/home/taste/esrocos_workspace/install/gr740/candriver/gr740_candriver.zip \
	--subCPP dump_joint_commands:/home/taste/esrocos_workspace/install/drivers/taste/controldev/dump_joint_commands.zip \
